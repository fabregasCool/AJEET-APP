...
import catSectionRoutes from './routes/catSections.js';
import presiSectionRoutes from './routes/presiSections.js';
...
app.use('/api/catSections', catSectionRoutes);
app.use('/api/presiSections', presiSectionRoutes);
